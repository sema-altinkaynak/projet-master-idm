...
/**
 * This is the item provider adapter for a {@link htmlProject.Page} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PageItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						HtmlProjectPackage.Literals.PAGE__NAME, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(HtmlProjectPackage.Literals.PAGE__CONTENEURS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		case HtmlProjectPackage.PAGE__NAME:
			fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
			return;
		case HtmlProjectPackage.PAGE__CONTENEURS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(HtmlProjectPackage.Literals.PAGE__CONTENEURS,
				HtmlProjectFactory.eINSTANCE.createListe()));

		newChildDescriptors.add(createChildParameter(HtmlProjectPackage.Literals.PAGE__CONTENEURS,
				HtmlProjectFactory.eINSTANCE.createEntete()));
	}

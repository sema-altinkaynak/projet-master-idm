...
/**
 * This is the item provider adapter for a {@link portail.Employe} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void addTelephonePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Employe_telephone_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Employe_telephone_feature", "_UI_Employe_type"),
				 PortailPackage.Literals.EMPLOYE__TELEPHONE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addBureauPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Employe_bureau_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Employe_bureau_feature", "_UI_Employe_type"),
				 PortailPackage.Literals.EMPLOYE__BUREAU,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addMailPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Employe_mail_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Employe_mail_feature", "_UI_Employe_type"),
				 PortailPackage.Literals.EMPLOYE__MAIL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,

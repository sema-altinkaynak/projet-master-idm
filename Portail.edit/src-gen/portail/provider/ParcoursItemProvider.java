...
/**
 * This is the item provider adapter for a {@link portail.Parcours} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ParcoursItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Parcours_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Parcours_name_feature", "_UI_Parcours_type"),
				 PortailPackage.Literals.PARCOURS__NAME,
				 true,
				 false,
				 false,
	...
	protected void addDescriptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Parcours_description_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Parcours_description_feature", "_UI_Parcours_type"),
				 PortailPackage.Literals.PARCOURS__DESCRIPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addResponsableParcoursPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Parcours_responsableParcours_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Parcours_responsableParcours_feature", "_UI_Parcours_type"),
				 PortailPackage.Literals.PARCOURS__RESPONSABLE_PARCOURS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addCompetencePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Parcours_competence_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Parcours_competence_feature", "_UI_Parcours_type"),
				 PortailPackage.Literals.PARCOURS__COMPETENCE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addDebouchePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Parcours_debouche_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Parcours_debouche_feature", "_UI_Parcours_type"),
				 PortailPackage.Literals.PARCOURS__DEBOUCHE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PortailPackage.Literals.PARCOURS__SEMESTRES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PortailPackage.Literals.PARCOURS__SEMESTRES,
				 PortailFactory.eINSTANCE.createSemestre()));
	}
